...
import{e as S,f as p,w as C,b as x,o as T,g as B,x as E,G as q,j as r,v as d,B as F,C as P}from"./vue.esm-bundler-26GhoP0B.js";import{_ as R}from"./_plugin-vue_export-helper-x3n3nnut.js";const z=a=>(F("data-v-196548ca"),a=a(),P(),a),D={class:"ui-input-range relative box-content h-lg py-xs"},N=["min","max","step"],U=z(()=>r("div",{class:"pointer-events-none absolute left-0 top-1/2 h-xs w-full -translate-y-1/2 rounded bg-secondary-alt"},null,-1)),f=S({__name:"ui-input-range",props:{modelValue:{},min:{},max:{},step:{}},emits:["update:modelValue"],setup(a,{emit:l}){const e=a,h=l,o=p({get(){return e.modelValue},set(n){h("update:modelValue",n)}});C(()=>[e.min,e.max],()=>{o.value<+e.min?o.value=+e.min:o.value>+e.max&&(o.value=+e.max)});const u=x(),m=p(()=>Math.round((+e.modelValue-+e.min)/(+e.max-+e.min)*100)),y=n=>{if(u.value){const t="clientX",{left:i,width:V}=u.value.getBoundingClientRect(),k="touches"in n?n.touches[0][t]:n[t],w=Math.min(Math.max((k-i)/V,0),1)||0,I=parseFloat(String(e.min))+w*(+e.max-+e.min),M=Math.round(I/+e.step)*+e.step;return parseFloat(Math.min(M,+e.max).toFixed(2))}},_=n=>{const t=y(n);t&&(o.value=t)};return(n,t)=>(T(),B("div",D,[E(r("input",{ref_key:"track",ref:u,"onUpdate:modelValue":t[0]||(t[0]=i=>o.value=i),class:"absolute left-0 top-0 size-full cursor-pointer appearance-none bg-transparent",type:"range",min:n.min,max:n.max,step:n.step,onTouchmove:_},null,40,N),[[q,o.value,void 0,{number:!0}]]),U,r("div",{class:"pointer-events-none absolute left-0 top-1/2 h-xs -translate-y-1/2 rounded bg-primary",style:d({width:m.value+"%"})},null,4),r("div",{class:"ui-input-range__thumb pointer-events-none absolute box-content size-xs -translate-x-1/2 -translate-y-1/2 rounded-full border-white bg-primary",style:d({left:m.value+"%"})},null,4)]))}}),b=R(f,[["__scopeId","data-v-196548ca"]]);f.__docgenInfo={exportName:"default",displayName:"ui-input-range",description:"",tags:{},props:[{name:"modelValue",required:!0,type:{name:"number"}},{name:"min",required:!0,type:{name:"union",elements:[{name:"string"},{name:"number"}]}},{name:"max",required:!0,type:{name:"union",elements:[{name:"string"},{name:"number"}]}},{name:"step",required:!0,type:{name:"union",elements:[{name:"string"},{name:"number"}]}}],events:[{name:"update:modelValue"}],sourceFiles:["/home/runner/work/bonkers-ui/bonkers-ui/src/components/ui-input-range/ui-input-range.vue"]};const j={title:"Components/ui-input-range",component:b,argTypes:{min:{control:{type:"number"},description:"The Element min value"},max:{control:{type:"number"},description:"The Element max value"},step:{control:{type:"number"},description:"The Element max value"}},args:{min:0,max:100,step:1}},s={render:a=>({components:{UiInputRange:b},setup(){const l=x(50);return{args:a,modelValue:l}},template:`
...
}`,...(g=(v=s.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};const G=["Default"];export{s as Default,G as __namedExportsOrder,j as default};
