...
import{e as b,b as l,o as u,g as c,p as w,z as B,n as k,I as R,J as U,v as C,T,j as S}from"./vue.esm-bundler-26GhoP0B.js";import{_ as N}from"./ui-button-Jz46TVZo.js";import{_ as $}from"./ui-typography-a0Uot2md.js";const E=["onAnimationend"],z=S("circle",{cx:"50",cy:"50",r:"50"},null,-1),A=[z],p=b({__name:"ui-ripple",setup(n){const i=l([]),a=l(),_=l(),y=e=>{if(a.value){const t=a.value.getBoundingClientRect();i.value.push({x:e.clientX-t.left,y:e.clientY-t.top,id:Math.random().toString(36).substr(2,9)})}},x=e=>{i.value=i.value.filter(t=>t.id!==e)};return(e,t)=>(u(),c("div",{ref_key:"tiBtn",ref:a,class:"ui-ripple",onClick:y},[w(e.$slots,"default"),B(T,null,{default:k(()=>[(u(!0),c(R,null,U(i.value,r=>(u(),c("svg",{ref_for:!0,ref:_.value,key:r.id,viewBox:"0 0 100 100",xmlns:"http://www.w3.org/2000/svg",class:"ripple",style:C({top:r.y+"px",left:r.x+"px"}),fill:"currentColor",onAnimationend:I=>x(r.id)},A,44,E))),128))]),_:1})],512))}});p.__docgenInfo={exportName:"default",displayName:"ui-ripple",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/bonkers-ui/bonkers-ui/src/components/ui-ripple/ui-ripple.vue"]};const G={title:"Components/ui-ripple",component:p},D=n=>({components:{UiRipple:p},setup(){return{args:n}},template:`
  ...
  template: /*html*/\`
        ...
        \`
})`,...(h=(g=o.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};const J=["Default","WithButton"];export{s as Default,o as WithButton,J as __namedExportsOrder,G as default};
