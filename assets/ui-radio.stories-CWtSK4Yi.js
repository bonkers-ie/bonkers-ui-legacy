import{U as i}from"./ui-radio-Dj-X-2Qq.js";import{r as t}from"./vue.esm-bundler-Dt7u_LQR.js";import{E as a}from"./align-CojEiJiX.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const p={title:"Components/ui-radio",component:i,argTypes:{justify:{control:{type:"select"},options:Object.values(a),description:"The Element justify"},invertOrder:{control:{type:"boolean"},description:"The Element order"},disabled:{control:{type:"boolean"},description:"The Element disabled state"},default:{control:{type:"text"}}},args:{default:"Some text",justify:a.START,invertOrder:!1,disabled:!1}},e={render:l=>({components:{UiRadio:i},setup(){const n=t("value4");return{args:l,modelValue:n}},template:`
