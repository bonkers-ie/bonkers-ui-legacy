...
import{d as b,r as l,o as u,a as c,h as w,l as B,w as k,F as R,B as U,j as C,T,b as S}from"./vue.esm-bundler-BKa0CVN1.js";import{_ as N}from"./ui-button-CBwcAxvj.js";import{_ as $}from"./ui-typography-Bbl87Fj8.js";const E=["onAnimationend"],F=S("circle",{cx:"50",cy:"50",r:"50"},null,-1),A=[F],p=b({__name:"ui-ripple",setup(n){const r=l([]),a=l(),_=l(),y=e=>{if(a.value){const t=a.value.getBoundingClientRect();r.value.push({x:e.clientX-t.left,y:e.clientY-t.top,id:Math.random().toString(36).substr(2,9)})}},x=e=>{r.value=r.value.filter(t=>t.id!==e)};return(e,t)=>(u(),c("div",{ref_key:"tiBtn",ref:a,class:"ui-ripple",onClick:y},[w(e.$slots,"default"),B(T,null,{default:k(()=>[(u(!0),c(R,null,U(r.value,i=>(u(),c("svg",{ref_for:!0,ref:_.value,key:i.id,viewBox:"0 0 100 100",xmlns:"http://www.w3.org/2000/svg",class:"ripple",style:C({top:i.y+"px",left:i.x+"px"}),fill:"currentColor",onAnimationend:W=>x(i.id)},A,44,E))),128))]),_:1})],512))}});p.__docgenInfo={exportName:"default",displayName:"ui-ripple",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/bonkers-ui/bonkers-ui/src/components/ui-ripple/ui-ripple.vue"]};const I={title:"Components/ui-ripple",component:p},D=n=>({components:{UiRipple:p},setup(){return{args:n}},template:`
        <div
            :style="{
                width: '500px',
                height: '500px',
