import{d as k,c as S,o as i,e as M,k as a,v as p,j as c,m as b,q as g,u as t,x as v,l as r,z as V,K as _,g as x,a as O}from"./vue.esm-bundler-d669bd99.js";import{E as f,_ as h,a as z}from"./ui-typography-8f06c7f1.js";const B={class:"ui-select"},E={class:"absolute right-sm top-1/2 -translate-y-1/2"},d=k({__name:"ui-select",props:{modelValue:{},heading:{},subLabel:{},disabled:{type:Boolean}},emits:["update:modelValue"],setup(o,{emit:s}){const l=o,u=S({get(){return l.modelValue},set(e){s("update:modelValue",e)}});return(e,m)=>(i(),M("div",B,[a(e.$slots,"heading",{},()=>[e.heading?(i(),p(t(h),{key:0,class:"mb-xs",size:t(f).MD},{default:c(()=>[b(g(e.heading),1)]),_:1},8,["size"])):v("",!0)]),r("div",{class:x(["relative rounded-lg border border-secondary-alt-500 bg-white hover:border-secondary-alt-700",[e.disabled&&"pointer-events-none border-secondary-alt-300 bg-secondary-alt-200"]])},[V(r("select",{"onUpdate:modelValue":m[0]||(m[0]=w=>u.value=w),class:"m-0 w-full cursor-pointer appearance-none border-0 bg-transparent p-sm italic text-secondary-alt outline-0"},[a(e.$slots,"default")],512),[[_,u.value]]),r("div",E,[a(e.$slots,"postfix-icon")])],2),a(e.$slots,"subLabel",{},()=>[e.subLabel?(i(),p(t(h),{key:0,size:t(f).SM,kind:t(z).SECONDARY_ALT,class:"mt-xs"},{default:c(()=>[b(g(e.subLabel),1)]),_:1},8,["size","kind"])):v("",!0)])]))}});d.__docgenInfo={exportName:"default",displayName:"ui-select",description:"",tags:{},props:[{name:"modelValue",required:!0,type:{name:"union",elements:[{name:"string"},{name:"number"}]}},{name:"heading",required:!1,type:{name:"string"}},{name:"subLabel",required:!1,type:{name:"string"}},{name:"disabled",required:!1,type:{name:"boolean"}}],events:[{name:"update:modelValue"}],slots:[{name:"heading"},{name:"default"},{name:"postfix-icon"},{name:"subLabel"}],sourceFiles:["/home/runner/work/bonkers-ui/bonkers-ui/src/components/ui-select/ui-select.vue"]};const q={title:"Components/ui-select",component:d,argTypes:{disabled:{control:{type:"boolean"},description:"The Element disabled state"}},args:{disabled:!1}},D=o=>({components:{UiSelect:d},setup(){const s=["Option 1","Option 2","Option 3"],l=O(s[0]);return{args:o,valueModel:l,list:s}},template:`
...
//# sourceMappingURL=ui-select.stories-cc7cbec3.js.map
