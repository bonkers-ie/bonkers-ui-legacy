import{_ as d}from"./ui-radio-fb222ed2.js";import{b as s}from"./vue.esm-bundler-1832156e.js";import{E as a}from"./align-e22983df.js";const p={title:"Components/ui-radio",component:d,argTypes:{justify:{control:{type:"select"},options:Object.values(a),description:"The Element justify"},invertOrder:{control:{type:"boolean"},description:"The Element order"},disabled:{control:{type:"boolean"},description:"The Element disabled state"}},args:{slot:"Some text",justify:a.START,invertOrder:!1,disabled:!1}},l=n=>({components:{UiRadio:d},setup(){const t=s("value4");return{args:n,modelValue:t}},template:`
...
//# sourceMappingURL=ui-radio.stories-3aa3213b.js.map
