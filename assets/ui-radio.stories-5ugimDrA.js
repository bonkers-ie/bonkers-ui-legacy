import{U as i}from"./ui-radio-a70dDQu-.js";import{b as t}from"./vue.esm-bundler-Cwk8bBuE.js";import{E as a}from"./align-qS2OfZfs.js";import"./_plugin-vue_export-helper-x3n3nnut.js";const p={title:"Components/ui-radio",component:i,argTypes:{justify:{control:{type:"select"},options:Object.values(a),description:"The Element justify"},invertOrder:{control:{type:"boolean"},description:"The Element order"},disabled:{control:{type:"boolean"},description:"The Element disabled state"},default:{control:{type:"text"}}},args:{default:"Some text",justify:a.START,invertOrder:!1,disabled:!1}},e={render:l=>({components:{UiRadio:i},setup(){const n=t("value4");return{args:l,modelValue:n}},template:`
