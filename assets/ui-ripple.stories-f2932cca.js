import{e as b,b as l,o as u,g as c,j as w,y as B,l as R,F as k,C as U,T as C,z as T,p as S}from"./vue.esm-bundler-8de1b0f8.js";import{_ as N}from"./ui-button-7367bfc3.js";import{_ as $}from"./ui-typography-103e2fbe.js";const E=["onAnimationend"],F=S("circle",{cx:"50",cy:"50",r:"50"},null,-1),z=[F],p=b({__name:"ui-ripple",setup(i){const s=l([]),a=l(),y=l(),h=e=>{if(a.value){const t=a.value.getBoundingClientRect();s.value.push({x:e.clientX-t.left,y:e.clientY-t.top,id:Math.random().toString(36).substr(2,9)})}},x=e=>{s.value=s.value.filter(t=>t.id!==e)};return(e,t)=>(u(),c("div",{ref_key:"tiBtn",ref:a,class:"ui-ripple",onClick:h},[w(e.$slots,"default"),B(C,null,{default:R(()=>[(u(!0),c(k,null,U(s.value,n=>(u(),c("svg",{ref_for:!0,ref:y.value,key:n.id,viewBox:"0 0 100 100",xmlns:"http://www.w3.org/2000/svg",class:"ripple",style:T({top:n.y+"px",left:n.x+"px"}),fill:"currentColor",onAnimationend:V=>x(n.id)},z,44,E))),128))]),_:1})],512))}});p.__docgenInfo={exportName:"default",displayName:"ui-ripple",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/bonkers-ui/bonkers-ui/src/components/ui-ripple/ui-ripple.vue"]};const I={title:"Components/ui-ripple",component:p,argTypes:{}},A=i=>({components:{UiRipple:p},setup(){return{args:i}},template:`
        <div
            :style="{
                width: '500px',
                height: '500px',
...
//# sourceMappingURL=ui-ripple.stories-f2932cca.js.map
