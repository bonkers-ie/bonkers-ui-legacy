import{d as w,o as r,c as _,g as l,f as d,j as u,t as c,u as e,h as n,b as p,a as S}from"./vue.esm-bundler-C-KwxiLQ.js";import{a as m,E as k,c as g,U as f,b as C}from"./index-C9LKT771.js";import{_ as U,E as D}from"./ui-badge-Chech2P1.js";import"./index-PqVpD0OJ.js";import{_ as T,E as z}from"./ui-icon-BaIdPYCX.js";const F=U,N={class:"relative flex flex-col gap-sm rounded-2xl border border-secondary-alt-500 bg-white px-xs py-sm"},O={class:"grid gap-xxs"},o=w({__name:"ui-product-card",props:{badgeText:{},title:{},subtitle:{}},setup(i){return(t,P)=>(r(),_("div",N,[t.badgeText?(r(),l(e(F),{key:0,class:"!absolute -top-xxs right-xs",kind:e(D).ACCENT_ALT,rounded:""},{default:d(()=>[u(c(t.badgeText),1)]),_:1},8,["kind"])):n("",!0),p(t.$slots,"header"),S("div",O,[p(t.$slots,"title",{},()=>[t.title?(r(),l(e(f),{key:0,size:e(m).MD,weight:e(k).BOLD,align:e(g).LEFT,"line-height":""},{default:d(()=>[u(c(t.title),1)]),_:1},8,["size","weight","align"])):n("",!0)]),p(t.$slots,"subtitle",{},()=>[t.subtitle?(r(),l(e(f),{key:0,size:e(m).XS,align:e(g).LEFT,kind:e(C).SECONDARY_400,"line-height":""},{default:d(()=>[u(c(t.subtitle),1)]),_:1},8,["size","align","kind"])):n("",!0)])])]))}});o.__docgenInfo={exportName:"default",displayName:"ui-product-card",description:"",tags:{},props:[{name:"badgeText",required:!1,type:{name:"string"}},{name:"title",required:!1,type:{name:"string"}},{name:"subtitle",required:!1,type:{name:"string"}}],slots:[{name:"header"},{name:"title"},{name:"subtitle"}],sourceFiles:["/home/runner/work/bonkers-ui/bonkers-ui/src/components/ui-product-card/ui-product-card.vue"]};const $={title:"Components/ui-product-card",component:o,argTypes:{title:{control:{type:"text"},description:"The title text"},subtitle:{control:{type:"text"},description:"The subtitle text"}},args:{title:"This is a Title",subtitle:"This is a Subtitle"}},a={render:i=>({components:{UiProductCard:o,UiIcon:T},setup(){return{args:i,ESize:z}},template:`
        ...
        `})},s={render:i=>({components:{UiProductCard:o,UiIcon:T},setup(){return{args:i,ESize:z}},template:`
