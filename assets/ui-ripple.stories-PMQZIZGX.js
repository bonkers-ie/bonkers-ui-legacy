...
import{e as b,b as l,o as u,g as c,p as w,z as B,n as k,H as R,I as U,v as C,J as S,j as T}from"./vue.esm-bundler-WCJNj6rQ.js";import{_ as N}from"./ui-button-Lc4xV15A.js";import{_ as $}from"./ui-typography-k4mcHZtK.js";const E=["onAnimationend"],z=T("circle",{cx:"50",cy:"50",r:"50"},null,-1),A=[z],p=b({__name:"ui-ripple",setup(n){const i=l([]),a=l(),_=l(),y=e=>{if(a.value){const t=a.value.getBoundingClientRect();i.value.push({x:e.clientX-t.left,y:e.clientY-t.top,id:Math.random().toString(36).substr(2,9)})}},x=e=>{i.value=i.value.filter(t=>t.id!==e)};return(e,t)=>(u(),c("div",{ref_key:"tiBtn",ref:a,class:"ui-ripple",onClick:y},[w(e.$slots,"default"),B(S,null,{default:k(()=>[(u(!0),c(R,null,U(i.value,r=>(u(),c("svg",{ref_for:!0,ref:_.value,key:r.id,viewBox:"0 0 100 100",xmlns:"http://www.w3.org/2000/svg",class:"ripple",style:C({top:r.y+"px",left:r.x+"px"}),fill:"currentColor",onAnimationend:I=>x(r.id)},A,44,E))),128))]),_:1})],512))}});p.__docgenInfo={exportName:"default",displayName:"ui-ripple",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/bonkers-ui/bonkers-ui/src/components/ui-ripple/ui-ripple.vue"]};const G={title:"Components/ui-ripple",component:p},D=n=>({components:{UiRipple:p},setup(){return{args:n}},template:`
        <div
            :style="{
                width: '500px',
                height: '500px',
