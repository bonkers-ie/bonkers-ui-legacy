...
import{e as N,b as k,o as u,g as c,j as l,H as m,I as S,p as x,B as D,C as w}from"./vue.esm-bundler-mcobj_hi.js";import{_ as B}from"./_plugin-vue_export-helper-x3n3nnut.js";const V=n=>(D("data-v-c13dfde7"),n=n(),w(),n),E={class:"inputs grid"},j=["type","onInput"],q=V(()=>l("div",{class:"bottom-wrapper"},null,-1)),y=N({__name:"ui-verification-input",props:{inputsCount:{},type:{}},emits:["onFiled"],setup(n,{emit:d}){const o=n,h=d,a=k([]),f=()=>{const e=a.value.map(t=>t==null?void 0:t.value).join("");h("onFiled",e)},I=(e,t)=>{var s;t<o.inputsCount&&((s=a.value[t+1])==null||s.focus()),t===o.inputsCount-1&&f()},b=e=>{e.target&&e.target.select()},H=e=>{var s,r;e.preventDefault();const t=(s=e.clipboardData)==null?void 0:s.getData("text");t&&t.length===o.inputsCount&&((r=a.value[o.inputsCount-1])==null||r.focus(),a.value.forEach((i,F)=>{i&&(i.value=t[F])}),f())};return(e,t)=>(u(),c(m,null,[l("div",E,[(u(!0),c(m,null,S(e.inputsCount,(s,r)=>(u(),c("div",{key:r,class:"input-wrapper"},[l("input",{ref_for:!0,ref_key:"inputsRefs",ref:a,type:e.type||"text",maxlength:"1",placeholder:"•",onInput:i=>I(i,r),onFocus:b,onPaste:H},null,40,j),q]))),128))]),x(e.$slots,"button",{},void 0,!0)],64))}}),C=B(y,[["__scopeId","data-v-c13dfde7"]]);y.__docgenInfo={exportName:"default",displayName:"ui-verification-input",description:"",tags:{},props:[{name:"inputsCount",required:!0,type:{name:"number"}},{name:"type",required:!1,type:{name:'"text"'}}],events:[{name:"onFiled"}],slots:[{name:"button"}],sourceFiles:["/home/runner/work/bonkers-ui/bonkers-ui/src/components/ui-verification-input/ui-verification-input.vue"]};const T={title:"Components/ui-verification-input",component:C,argTypes:{inputsCount:{control:{type:"number"},description:"Number of inputs"},type:{control:{type:"select"},options:["text"],description:"Inputs type"}},args:{inputsCount:4,type:"text"}},p={render:n=>({components:{UiVerificationInput:C},setup(){return{args:n,filedHandler:o=>{console.log("=--->",o)}}},template:`
